# Per-OS Icon Spec ΓÇö phenotype-journeys
...
Hand-authored SVG at `assets/brand/logo.svg` ΓÇö a winding "journey path"
...
| CLI         | (none ΓÇö headless)                             | ΓÇö             | n/a |
| Crates      | (none ΓÇö cargo doesn't display logos)          | ΓÇö             | n/a |
...
- Raster: resvg ΓåÆ ImageMagick ΓåÆ Pillow fallback.
