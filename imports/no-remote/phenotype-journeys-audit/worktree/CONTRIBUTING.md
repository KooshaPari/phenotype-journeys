# Contributing to phenotype-journeys
...
## Scripting policy
Rust default; Zig/Mojo/Go with one-line justification; Python/TS embedded only; Bash as Γëñ5-line glue with inline justification.
